...
<html lang="en" class="light-style  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?php echo base_url() ?>assets/"
...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/<?php echo base_url() ?>assets/img/favicon/favicon.ico" />
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/libs/%40form-validation/umd/styles/index.min.css" />
...
<body>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Dev Dispatchers 👋</h4>
                        <p class="mb-4">Unlock Your Blogging Journey Here.</p>
    ...
    <script src="<?php echo base_url() ?>assets/vendor/libs/%40form-validation/umd/plugin-bootstrap5/index.min.js"></script>
    <script src="<?php echo base_url() ?>assets/vendor/libs/%40form-validation/umd/plugin-auto-focus/index.min.js"></script>

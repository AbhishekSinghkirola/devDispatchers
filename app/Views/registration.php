    ...
    <div class="authentication-wrapper authentication-cover">
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-4 align-items-center justify-content-end p-5 pe-0">
                <div class="w-px-400">
                    <img src="assets/img/backgrounds/blog-img.png" class="img-fluid" alt="multi-steps" width="600"
                        data-app-dark-img="backgrounds/blog-img.png" data-app-light-img="backgrounds/blog-img.png">
                </div>
            </div>
            <!-- /Left Text -->
                                ...
                                <div id="accountDetailsValidation" class="content">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" value="Neha Rawat" name="multiStepsUsername"
                                                id="multiStepsUsername" class="form-control" placeholder="johndoe" />
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label" for="multiStepsEmail">Email</label>
                                            <input type="email" value="nr7584128@gmail.com" name="multiStepsEmail"
                                        ...
                                        <div class="col-sm-6 form-password-toggle">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <input type="password" value="rawat" id="multiStepsPass"
                                        ...
                                        <div class="col-sm-6 form-password-toggle">
                                            <label class="form-label" for="multiStepsConfirmPass">Confirm
                                                Password</label>
                                            <div class="input-group input-group-merge">
                                                <input type="password" value="rawat" id="multiStepsConfirmPass"
                        ...
                        placeholder="johndoe/profile" aria-label="johndoe" />
                                ...
                                <div id="personalInfoValidation" class="content">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label" for="multiStepsArea">Country
                                            </label>
                                            <input type="text" id="multiStepsArea" name="multiStepsArea"
                                                class="form-control" placeholder="Area/Country" />
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-12 d-flex justify-content-between">
                                            ...
                                            <div>
                                                <button type="reset"
                                                    class="btn btn-danger btn-next btn-submit">Reset</button>
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content" for="basicOption">
                                                    <span class="custom-option-body">
                                                        ...
                                                        <span class="mb-2 d-block">A simple start for start ups &
                                                            Students</span>
                                                        <span class="d-flex justify-content-center">
                                                            <sup class="text-primary fs-big lh-1 mt-3">$</sup>
                                                            <span class="display-5 text-primary">0</span>
                                                            <sub
                                                                class="lh-1 fs-big mt-auto mb-2 text-muted">/month</sub>
                                                        </span>
                                                    </span>
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <span class="mb-2 d-block">Solution for enterprise &
                                                            organizations</span>
                                                        <span class="d-flex justify-content-center">
                                                            <sup class="text-primary fs-big lh-1 mt-3">$</sup>
